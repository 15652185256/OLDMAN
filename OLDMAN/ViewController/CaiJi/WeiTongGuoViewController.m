...
#import "WeiTongGuoViewController.h"
...
@interface WeiTongGuoViewController ()<UITableViewDataSource,UITableViewDelegate>
{
...
@implementation WeiTongGuoViewController
...
-(void)loadData:(int)page
{
    ...
    [_rootViewModel GetRootList:getgrxxHttp type:2 currentPage:[NSString stringWithFormat:@"%d",page] pageSize:[NSString stringWithFormat:@"%d",20]];
