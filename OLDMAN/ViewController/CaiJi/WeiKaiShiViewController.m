...
#import "WeiKaiShiViewController.h"
...
@interface WeiKaiShiViewController ()<UITableViewDataSource,UITableViewDelegate>
{
...
@implementation WeiKaiShiViewController
...
-(void)loadData:(int)page
{
    ...
    [_rootViewModel GetRootList:getStartGrxxHttp type:0 currentPage:[NSString stringWithFormat:@"%d",page] pageSize:[NSString stringWithFormat:@"%d",20]];
