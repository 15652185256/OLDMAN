...
@interface JinXingZhongViewController ()<UITableViewDataSource,UITableViewDelegate>
{
...
-(void)loadData:(int)page
{
    ...
    [_rootViewModel GetRootList:getRunningGrxxHttp type:1 currentPage:[NSString stringWithFormat:@"%d",page] pageSize:[NSString stringWithFormat:@"%d",20]];
