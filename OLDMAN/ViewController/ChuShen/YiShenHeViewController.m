...
@interface YiShenHeViewController ()<UITableViewDataSource,UITableViewDelegate>
{
...
-(void)loadData:(int)page
{
    ...
    [_rootViewModel GetRootList:getgrxxHttp type:5 currentPage:[NSString stringWithFormat:@"%d",page] pageSize:[NSString stringWithFormat:@"%d",20]];
