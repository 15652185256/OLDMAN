...
#import "DaiShenHeViewController.h"
...
@interface DaiShenHeViewController ()<UITableViewDataSource,UITableViewDelegate>
{
...
@implementation DaiShenHeViewController
...
-(void)loadData:(int)page
{
    ...
    [_rootViewModel GetRootList:getgrxxHttp type:4 currentPage:[NSString stringWithFormat:@"%d",page] pageSize:[NSString stringWithFormat:@"%d",20]];
