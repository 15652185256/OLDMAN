...
#import "NeedBuChongXXViewController.h"
#import "BuChongXXModel.h"
#import "CollectViewModel.h"

#import "RNBlurModalView.h"//弹出框
@interface NeedBuChongXXViewController ()
{
...
@implementation NeedBuChongXXViewController
...
-(void)loadData
{
    ...
    [_collectViewModel SelectAssessmentResult:self.shenFenZJ tableFlag:@"27"];
...
-(void)Save_Button_Click
{
    ...
    [parameter setObject:@"27" forKey:@"tableFlag"];
